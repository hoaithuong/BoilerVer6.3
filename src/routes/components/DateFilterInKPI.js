...
import { DateFilter, DateFilterHelpers, Kpi } from "@gooddata/react-components";
// import "@gooddata/react-components/styles/css/dateFilter.css";
import { projectId, dateDatasetIdentifier, totalSalesIdentifier } from "../utils/fixtures";
...
export class DateFilterInKPI extends Component {
    constructor(props) {
        super(props);
...
export default DateFilterInKPI;
